...
public class PaperPicture {
    ...
    //---------------------------------------------------------
    public static Bitmap createIndexedImage(Bitmap bitmap,boolean isLvl)
    {
//        EPaperDisplay epd = EPaperDisplay.getDisplays()[EPaperDisplay.epdInd];
//
        srcBmp = bitmap;
        dstBmp = Bitmap.createBitmap(App.getDeviceInfo().getWidth(), App.getDeviceInfo().getHeight(), srcBmp.getConfig());
