package com.fmsh.einkesl.tools.crop.view;
...
import com.fmsh.einkesl.tools.crop.edge.Edge;
import com.fmsh.einkesl.tools.crop.handle.CropWindowEdgeSelector;
import com.fmsh.einkesl.tools.crop.util.CatchEdgeUtil;
...
public class CropImageView extends AppCompatImageView {
    ...
    private void initCropWindow(@NonNull RectF bitmapRect) {
        ...
        //裁剪框距离图片左右的padding值
        final float horizontalPadding = 0.20f * bitmapRect.width();
        final float verticalPadding = 0.30f * bitmapRect.height();
